...
const CreateMed = () => {
  ...
  return (<>
    ...
    {!isLoading && (
      ...
      <div>
        <form className="form">
          <span className="title" style={{ marginBottom: "5px" }}>CREATE MEDICINE</span>
          <Stack direction="column" width="100%" sx={{ justifyContent: "center", marginLeft: "30px" }}>
            <Typography sx={{ textAlign: "left", justifyContent: "flex-start", fontWeight: 700 }}>Medicine Name* :</Typography>
            <input
              type="text"
              className="input"
          ...
          <Stack direction="column" width="100%" sx={{ marginTop: "16px", marginLeft: "30px" }}>
            <Typography sx={{ textAlign: "left", justifyContent: "flex-start", fontWeight: 700 }}>Medicine Description* :</Typography>
            <input
              type="text"
              className="input"
